...
configurations = {
    'conf1': {
        'inputPath':    "simsMC",
        'outputPath':   "data",
        'filename64':   "dataset64MCnoB.npz",
        'filename32':   "dataset32MCnoB.npz",
        'noiseSD':        None,
    },
    'conf2': {
        'inputPath':    "simsMC",
        'outputPath':   "data",
        'filename64':   "dataset64MCnoB-n025.npz",
        'filename32':   "dataset32MCnoB-n025.npz",
        'noiseSD':        0.025,
    },
    'conf3': {
        'inputPath':    "simsMC",
        'outputPath':   "data",
        'filename64':   "dataset64MCnoB-n01.npz",
        'filename32':   "dataset32MCnoB-n01.npz",
        'noiseSD':        0.01,
    },
    'conf4': {
        'inputPath':    "simsMC",
        'outputPath':   "data",
        'filename64':   "dataset64MCnoB-n05.npz",
        'filename32':   "dataset32MCnoB-n05.npz",
        'noiseSD':        0.05,
    },
}
...
if __name__ == "__main__":
    ...
    numCombinations = len(valuesY0)*len(valuesA)*len(valuesW1)

    startTime = datetime.now()

    first = True
    for iNN, nN in enumerate(valuesNN):
        for iPar, par in enumerate(product(valuesY0, valuesA, valuesW1)):
            parString = "{}_{}_{}_{}_{}".format(par[0], par[1], valueB, par[2], nN)
